...
void LightBindings::SetDirectionalLight(Ref<Shader>& shader, const Ref<LightComponent>& lightComponenet)
{
...
void LightBindings::SetPointLight(Ref<Shader>& shader, const  Ref<LightComponent>& lightComponent, const size_t index)
{
...
void LightBindings::SetSpotLight(Ref<Shader>& shader, const  Ref<LightComponent>& lightComponenet, const size_t index)
{
