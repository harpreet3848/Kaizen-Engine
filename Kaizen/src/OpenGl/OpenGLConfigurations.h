...
public:
	...
	static inline void SetWindingOrder(WindingOder windingOder) { glFrontFace(GL_ENUM(windingOder)); }

	static inline bool IsStateActive(RendererStates rendererState) { return (glIsEnabled(GL_ENUM(rendererState)) == GL_TRUE); }
